...
class TestResultsTest(RiftTestCase):
    ...
    def test_add_success(self):
        results = TestResults()
        results.add_success(TestCase('test1', 'pkg', 'x86_64', 'rpm'), 1)
        results.add_success(TestCase('test2', 'pkg', 'x86_64', 'rpm'), 1)
        self.assertTrue(results.global_result)
        self.assertEqual(len(results), 2)

    def test_add_failure(self):
        results = TestResults()
        results.add_failure(TestCase('test1', 'pkg', 'x86_64', 'rpm'), 1)
        results.add_failure(TestCase('test2', 'pkg', 'x86_64', 'rpm'), 1)
    ...
    def test_extend(self):
        results = TestResults()
        results.add_success(TestCase('test1', 'pkg1', 'x86_64', 'rpm'), 1)
        results.add_failure(TestCase('test2', 'pkg1', 'x86_64', 'rpm'), 1)
        others = TestResults()
        others.add_success(TestCase('test1', 'pkg2', 'x86_64', 'rpm'), 1)
        others.add_failure(TestCase('test2', 'pkg2', 'x86_64', 'rpm'), 1)
