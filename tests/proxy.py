...
from rift.proxy import (
    ...
    _TokenAuthenticatedRepositoryProxyHandler,
)
...
class TokenAuthenticatedRepositoryProxyHandlerTest(RiftTestCase):
    def test_build_upstream_url(self):
        url = _TokenAuthenticatedRepositoryProxyHandler._build_upstream_url(
    ...
    def test_build_forward_headers(self):
        handler = _TokenAuthenticatedRepositoryProxyHandler.__new__(
            _TokenAuthenticatedRepositoryProxyHandler
        )
        handler.headers = {
            "Host": "127.0.0.1:8080",
...
class AuthenticatedRepositoryProxyRuntimeTest(RiftTestCase):
    ...
    def test_init(self, mock_auth):
        ...
        self.assertIsNone(runtime.auth)
